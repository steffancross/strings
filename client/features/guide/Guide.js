      ...
      >
        <motion.div className="carousel">
          <div className="carousel-item">
            ...
            <p>
              The search bar at the top of the window is the main way to
              navigate the site. Besides when a popup is open, pressing{" "}
              <em>'/'</em> will focus the search bar and allow you to type
              commands.
            </p>
            <h1 className="guide-title">Navigation</h1>
            <p>
              With navigation commands, just type location you want into the
              search bar at the top and you'll be taken to the corresponding
              page.
            </p>
          ...
          <div className="carousel-item">
            ...
            <div className="guide-example">
              ...
              <em>search: and</em>
              <p>
                This would return all mats that contain 'and' whether it's a
                word on its own or part of a word such as 'brand'
              </p>
            </div>
            <div className="guide-command">
              <em>filter</em>
              <p>
                &nbsp;this functions like search but with tags and will return
                all mats associated with the input tag
              </p>
            </div>
            <div className="guide-example">
              <small>example</small>
          ...
          <div className="carousel-item">
            ...
            <p>
              When adding or editing a mat in the 'tags' input field, once
              again, there is syntax. If adding or assigning more than one tag,
